...
public class GameTest {
    ...
    void gameSetup(){
        ...
        Room room2 = new Room("The main entrance","You entered the main entrance, there is broken glass all over the ground," +"" +
                "among the shattered glass, are broken picture frames");
        Room room3 = new Room("The dining room","You entered the dining room, there is a big old clock which is very loud,"+
        ...
        Room room7 = new Room("The bedroom","The room seems to be a bedroom but it's very dark. " +
                "You can feel cobweb all over you and see a little reflection near the night stand.");
        Room room8 = new Room("The kitchen","You are in what seems to be the kitchen. " +
                "It's very smokey and hard to see. " +
                "You can faintly see a staircase but can't put a finger on the which way to get to it.");
        Room room9 = new Room("The bathroom","Room 9 seems to be the bathroom. " +
