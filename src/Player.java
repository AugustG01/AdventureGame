...
public class Player {
    ...
    public void hit(Enemy enemy) throws UnsupportedAudioFileException, LineUnavailableException, IOException, UnsupportedAudioFileException, LineUnavailableException, IOException {
